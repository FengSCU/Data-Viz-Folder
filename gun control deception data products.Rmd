...
Improper scaling is another common deception technique. When visualizing the data, people usually are very sensitive to the volumn, size, and shapes of data (Krystian, 2016). So by improper scaling will affect readers' vision of data and cause the readers receive wrong message. Also by using illustration instead of proper columns counts for distraction and not easy to read (2016).
...
![Mass shooting calendar] (mass_shooting_calendar.png)

### New Argument: Not all days are equal, mass shooting actually happended most on weekend in 2015.
[](https://public.tableau.com/profile/feng.wang2440#!/vizhome/mass_shootingweekday/Sheet1)
