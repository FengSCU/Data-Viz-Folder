...
![Vox Argument 1](image/finding1_vox.png)
Source: *the Guardian*

![First Version](image/firearm rate per 1M HDI Highest Country.png)

![First Version 2](image/firearm rate with all OECD.png)

![Final Version](image/1.firearm_world_final.png)
Tableau link and source:
